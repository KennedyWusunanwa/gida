  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F7F0E6] p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-xl shadow p-6 space-y-4">
        ...
        <input type="email" placeholder="Admin email" className="w-full border px-4 py-2 rounded" value={email} onChange={(e) => setEmail(e.target.value)} />
        ...
        <button type="submit" disabled={loading} className="bg-[#5B3A1E] text-white px-4 py-2 rounded w-full hover:opacity-90 disabled:opacity-60">
