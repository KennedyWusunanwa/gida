...
export default function MyListings() {
  ...
  const [form, setForm] = useState({ title: "", location: "", city: "", price: "", description: "" });
  ...
  const toggleSelectAll = () => {
    ...
    else setSelected(listings.map((l) => l.id));
  };
...
const deleteSelected = async () => {
  ...
  const cancelEdit = () => {
    setEditingId(null);
    setForm({ title: "", location: "", city: "", price: "", description: "" });
  };
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 12 }}>
        ...
        <button
          ...
          title={selected.length ? `Delete ${selected.length} selected` : "Nothing selected"}
        >
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    {!isEditing ? (
                      <>
                        ...
                        <button className="btn btn--danger" onClick={() => deleteOne(it.id)}>
                          Delete
                        </button>
                      </>
                    ) : (
